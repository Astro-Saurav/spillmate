  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-medium hover:shadow-soft rounded-2xl font-semibold",
        therapeutic: "bg-therapeutic text-therapeutic-foreground hover:bg-therapeutic/80 shadow-soft hover:shadow-medium rounded-2xl",
        wellness: "bg-wellness text-wellness-foreground hover:bg-wellness/80 shadow-soft hover:shadow-medium rounded-2xl",
        cta: "bg-gradient-to-r from-primary to-accent text-white hover:from-primary/90 hover:to-accent/90 shadow-medium hover:shadow-soft rounded-2xl font-semibold",
      },
      size: {
